...
internal static class Program
{
    ...
    private static ulong FindMemoryHole(IntPtr hProcess, ulong exportAddress, int size)
    {
        ...
        {
            // Note: Allocating memory in the target process here.
            // Since it's not mapped from a file on disk, the OS will flag this as MEM_PRIVATE.
            // -> This means I should look for unbacked MEM_PRIVATE + Executable regions in Phase 1 of my scanner.
    ...
    public static void Main(string[] args)
    {
        ...
        // Note: Changing memory protection of the target export from RX to RWX here.
        // This VirtualProtect call on a .text section is probably the weakest point that EDRs catch easily.
        // (This makes sense why Legacyy targets the .data section instead, which is already RW).
        ...
        // Note: 0xE8 is the CALL instruction in assembly (JMP is 0xE9).
        // They are writing this byte to the start of the function to create the inline hook.
        // -> I can detect this by scanning .text sections for 0xE8/0xE9 and checking if the jump target points to a MEM_PRIVATE region!
        ...
        // Note: Final step. Writing the actual shellcode payload into the MEM_PRIVATE region allocated earlier.
        status = WriteVirtualMemory(
            hProcess,
            (IntPtr)loaderAddress,
            payload,
